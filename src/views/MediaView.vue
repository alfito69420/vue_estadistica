<template>
  <div class="flex flex-col items-center">
    <h1 class="text-center mt-6">MEDIA</h1>
    <input
    ...
    />
    <button class="btn mt-4" @click="calcularMedia">Calcular</button>
    <h1 class="text-center mt-4">La media es: {{ media }}</h1>
...
if (numeros.length < 20) {
  ...
  const url = 'https://nqvo8awo2c.execute-api.us-east-1.amazonaws.com/media';
  ...
  try {
    ...
    media.value = responseData.media;
